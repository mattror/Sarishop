    ...
    <div class="header-sticky" id="stick-bar" onscroll="hidden()">
        ...
        <div class="nav-bar">
            ...
            <div class="user-utility-bar">
                <div class="like"><a href="#"><i class="fa fa-heart-o badge"></i></a></div>
                <div class="like bag"><a href="bag.php"><i class="fa fa-shopping-bag badge"></i></i></a></div>
                <div class="like sign-up"><a href="myaccount.php"><i class="fa fa-user-circle-o"></i></a></div>
            </div>
        </div>
    </div>
    <div class="container">
